const Chocotree = () => {
  return (
    <div style={{ textAlign: 'center', padding: '50px' }}>
      <h1 style={{fontSize:'60px'}}>한이 픽! 초코나무 숲</h1>
      <img
        src="/images/한이초코나무.png"
        alt="초코나무숲"
      ...
      <div className="menu-view__container">
        ...
        <div style={{ overflowX: 'auto', maxWidth: '100%', margin: '0 auto' }}> 
          ...
          >
            ...
            <tbody>
              <tr>
                {['115g', '301kcal', '29g', '4g', '11g', '117mg', '우유, 대두, 밀'].map((val, idx) => (
