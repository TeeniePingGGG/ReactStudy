...
props(프롭스)
  ...
  형식]
    <컴포넌트 props속성명={전달할 값}/>
    -> 이렇게 전달하면 자식 컴포넌트에서는 'props.속성명'과 같이 사용할 수 있다.
*/

/*
컴포넌트로 전달되는 모든 프롭스를 매개변수 props를 통해 한꺼번에 닫는다.
...
function App(){
  ...
  const backData =['Java','Oracle','JSP','Spring Boot','Nextjs'];
